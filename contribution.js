...
const CONTRIBUTION_ABI = [
    ...
    'function getUserContribution(address) view returns (uint256 totalTokens, uint256 instant, uint256 staked, uint256 ethSpent)',
...
class ContributionContract {
    ...
    async getUserContribution(address) {
        try {
            ...
            return { totalTokens: ethers.BigNumber.from(0), instant: ethers.BigNumber.from(0), staked: ethers.BigNumber.from(0), ethSpent: ethers.BigNumber.from(0) };
        }
    }
